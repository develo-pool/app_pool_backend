...
public enum PoolUserExceptionType implements BaseExceptionType {
    //== 회원가입, 로그인 시 ==//
    ...
    TOKEN_INVALID(401, HttpStatus.BAD_REQUEST, "token expired");

    private int errorCode;
    private HttpStatus httpStatus;
    private String errorMessage;

    PoolUserExceptionType(int errorCode, HttpStatus httpStatus, String errorMessage) {
