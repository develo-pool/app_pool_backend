...
public class QComment extends EntityPathBase<Comment> {
    ...
    private static final long serialVersionUID = 813380022L;
    ...
    public final app.pool.project.message.QMessage message;
    ...
    public QComment(Class<? extends Comment> type, PathMetadata metadata, PathInits inits) {
        ...
        this.message = inits.isInitialized("message") ? new app.pool.project.message.QMessage(forProperty("message"), inits.get("message")) : null;
